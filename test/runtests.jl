...
# !!! Main.UserApp is configured as an alias for Main.DigitRecognition and you might encounter it in some tests
using Main.DigitRecognition, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DigitRecognition tests" begin
  @includetests ARGS
end
